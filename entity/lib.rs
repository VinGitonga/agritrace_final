...
mod entity {
    ...
    mod tests {
        ...
        fn default_works() {
            ...
            assert_eq!(entity.get(), false);
        }

        /// We test a simple use case of our contract.
        #[ink::test]
        fn it_works() {
            let mut entity = Entity::new(false);
            assert_eq!(entity.get(), false);
            entity.flip();
            assert_eq!(entity.get(), true);
        }
    }
    ...
    mod e2e_tests {
        ...
        async fn default_works(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            // Given
            let constructor = EntityRef::default();
            ...
            // Then
            let get = build_message::<EntityRef>(contract_account_id.clone())
                .call(|entity| entity.get());
