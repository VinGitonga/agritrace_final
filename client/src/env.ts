...
export const TRANSACTIONS_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_TRANSACTIONS_CONTRACT_ADDRESS || "";
export const AGRITRACE_BASE_URL = process.env.NEXT_PUBLIC_AGRITRACE_BASE_URL || "";
